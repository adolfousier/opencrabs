...
| `whatsapp_send` | 26 actions: send, reply, delete, react, polls, typing, mark_read, photos, documents, audio/voice notes, video, stickers, location, contacts, pin/unpin, forward, block/unblock/list_blocked, profile name and status, status_update, list_newsletters, create_label, assign_label |
